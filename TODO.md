...
- [ ] C003: 考虑是否要按行显示楼盘，具体见：[Propose 修改数据展示的结构](https://github.com/WeNeedHome/SummaryOfLoanSuspension/pull/786)
- [ ] ...
...
- [x] B003: 增加了可视化脚本，具体见：[genMap.ts](./development/backend/src/genMap.ts)
